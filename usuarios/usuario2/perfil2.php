...
<head>
    ...
    <title>RapiBnB - Usuario 1 - Perfil - Usuario2</title>
</head>
<body>
    ...
    <div class="row min-vh-95 mt-2 mb-2 align-items-center align-content-center">
        <div class="col-md-3">
            <div class="text-center">
              <img src="perfil-usr2.jpg" class="rounded-circule mw-50" alt="imagen perfil" style="border-radius: 30%;" width="100%" height="240px">
            </div>
        </div>
        <div class="col-md-9 mt-md-0">
            <div class="home-text">
              <h2 class="fs-4">Novak Djokovic</h2>
              <p class="mt-4 text-muted">Hola, un cordial saludo, soy Novak Djokovic.
    ...
    <div class="row">
        <div class="col-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card mb-3" style="max-width: 100%;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="post1/img-mdz-1.jpeg" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Departamento para turismo MaryBer</h5>
                            <h5 class="card-title">$34000</h5>
                            <p class="card-text">Capacidad hasta 3 personas como maximo - No se reciben mascotas de ninguna indole..</p>
